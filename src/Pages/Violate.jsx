                    ...
                    <div className="flex flex-col mt-8 bg-gray-100 p-5 rounded-lg shadow overflow-y-auto ">
                        ...
                        <form>
                            ...
                            <div className='flex justify-center gap-5'>
                                ...
                                <button type="submit" className="mt-10 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-10 py-2.5 text-center ">Lưu</button>
                            </div>
